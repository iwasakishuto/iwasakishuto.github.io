...
* Edited by iwasakishuto <https://github.com/iwasakishuto>
*/
!function(e, t) {
  ...
  var ee, te, ne = {
      ...
      (e.exports = function(e, t, a, o) {
          var s = !!o && !!o.unsafe
            , l = !!o && !!o.enumerable
            , u = !!o && !!o.noTargetGet;
          "function" == typeof a && ("string" != typeof t || w(a, "name") || N(a, "name", t),
          n(a).source = i.join("string" == typeof t ? t : "")),
          e !== r ? (s ? !u && e[t] && (l = !0) : delete e[t],
          l ? e[t] = a : N(e, t, a)) : l ? e[t] = a : M(t, a)
      }
  ...
  , De = function(e) {
      ...
      return w(Fe, e) || (ze && w(Ue, e) ? Fe[e] = Ue[e] : Fe[e] = Be("Symbol." + e)),
      Fe[e]
  }, We = qe("species"), _e = function(e, t) {
      var n;
      return Te(e) && ("function" != typeof (n = e.constructor) || n !== Array && !Te(n.prototype) ? m(n) && null === (n = n[We]) && (n = void 0) : n = void 0),
  ...
  , Lt = oe("document", "documentElement"), Ct = K("IE_PROTO"), Pt = function() {}, Nt = function(e) {
      ...
      Mt = Rt ? function(e) {
          ...
          return e = null,
          t
      }(Rt) : ((t = k("iframe")).style.display = "none",
      Lt.appendChild(t),
      ...
      for (var n = be.length; n--; )
          delete Mt.prototype[be[n]];
      return Mt()
  };
  $[Ct] = !0;
  var It = Object.create || function(e, t) {
      var n;
      return null !== e ? (Pt.prototype = L(e),
      n = new Pt,
      Pt.prototype = null,
      n[Ct] = e) : n = Mt(),
      void 0 === t ? n : xt(n, t)
  ...
  : function(e) {
    ...
    , hn = function(e, t, n) {
      ...
      var i = y(t, !0);
      return L(n),
      w(tn, i) ? (n.enumerable ? (w(e, Wt) && e[Wt][i] && (e[Wt][i] = !1),
      n = It(n, {
          enumerable: c(0, !1)
      })) : (w(e, Wt) || Qt(e, Wt, c(1, {})),
      e[Wt][i] = !0),
    ...
    , gn = function(e, t) {
      ...
      if (n !== Xt || !w(tn, i) || w(nn, i)) {
          var r = Jt(n, i);
          return !r || !w(tn, i) || w(n, Wt) && n[Wt][i] || (r.enumerable = !0),
          r
      }
  }
    , pn = function(e) {
  ...
  var On = "[object z]" === String(In)
    ...
    , Hn = function(e) {
      if (null != e)
          return e[zn] || e["@@iterator"] || Cn[jn(e)]
  }
    , Fn = qe("iterator")
    , Un = !1;
  try {
  ...
  Oe({
      ...
      from: function(e) {
          ...
          if (d && (c = at(c, u > 2 ? arguments[2] : void 0, 2)),
          null == h || l == Array && Mn(h))
              for (n = new l(t = de(s.length)); t > f; f++)
                  o = d ? c(s[f], f) : s[f],
                  je(n, f, o);
          else
              for (a = (r = h.call(s)).next,
              n = new l; !(i = a.call(r)).done; f++)
                  o = d ? Ln(r, c, [i.value, f], !0) : i.value,
                  je(n, f, o);
          return n.length = f,
          n
      }
  ...
  var si = Object.setPrototypeOf || ("__proto__"in {} ? function() {
    ...
    , li = function(e, t, n) {
      var i, r;
      return si && "function" == typeof (i = t.constructor) && i !== n && m(r = i.prototype) && r !== n.prototype && si(e, r),
      e
  }
    , ui = "\t\n\v\f\r                　\u2028\u2029\ufeff"
    , ci = "[" + ui + "]"
      ...
      (e.exports = function(e, n, i, r, a) {
          ...
          if (a)
              ...
              if (Mn(s)) {
                  for (l = 0,
                  u = de(e.length); u > l; l++)
                      if ((c = r ? f(L(h = e[l])[0], h[1]) : f(e[l])) && c instanceof t)
                          return c;
                  return new t(!1)
              }
              o = s.call(e)
          ...
          for (d = o.next; !(h = d.call(o)).done; )
              if ("object" == typeof (c = Ln(o, f, h.value, r)) && c && c instanceof t)
                  return c;
          return new t(!1)
      }
      ).stop = function(e) {
  ...
  : qi && !zi ? (Mi = (Ni = new qi).port2,
  Ni.port1.onmessage = Yi,
  Pi = at(Mi.postMessage, Mi, 1)) : !r.addEventListener || "function" != typeof postMessage || r.importScripts || a(Gi) || "file:" === Hi.protocol ? Pi = Ki in k("script") ? function(e) {
  ...
  : (Pi = Gi,
  r.addEventListener("message", Yi, !1)));
  ...
  new lr(Ji).observe(nr, {
      characterData: !0
  }),
  er = function() {
      nr.data = tr = !tr
  }
  ) : cr && cr.resolve ? (ir = cr.resolve(void 0),
  rr = ir.then,
  er = function() {
      rr.call(ir, Ji)
  }
  ...
  , br = function(e) {
      ...
      if (!(H(Pr) !== String(Pr))) {
          if (66 === Ye)
              return !0;
          if (!jr && "function" != typeof PromiseRejectionEvent)
              return !0
      }
      if (Ye >= 51 && /native code/.test(Pr))
          return !1;
      var e = Pr.resolve(1)
        , t = function(e) {
          e((function() {}
      ...
      if (!t.notified) {
          ...
          yr((function() {
              for (var r = t.value, a = 1 == t.state, o = 0; i.length > o; ) {
                  ...
                  try {
                      d ? (a || (2 === t.rejection && Kr(e, t),
                      t.rejection = 1),
                      !0 === d ? s = r : (v && v.enter(),
                      s = d(r),
                      v && (v.exit(),
                      u = !0)),
                      s === c.promise ? f(Nr("Promise-chain cycle")) : (l = Br(s)) ? l.call(s, h, f) : h(s)) : f(r)
                  } catch (e) {
                      v && !u && v.exit(),
                      f(e)
                  }
              ...
              t.reactions = [],
              t.notified = !1,
              n && !t.rejection && _r(e, t)
          }
          ))
      }
  }, Wr = function(e, t, n) {
      var i, a;
      zr ? ((i = Mr.createEvent("Event")).promise = t,
      i.reason = n,
      i.initEvent(e, !1, !0),
      r.dispatchEvent(i)) : i = {
          promise: t,
      ...
      if (!t.done) {
          ...
          try {
              if (e === n)
                  throw Nr("Promise can't be resolved itself");
              var r = Br(n);
              r ? yr((function() {
                  var i = {
                      done: !1
  ...
  ,
  "function" == typeof Ii && (mr = Ii.prototype.then,
  ie(Ii.prototype, "then", (function(e, t) {
      var n = this;
  ...
  }, ta = RegExp.prototype.exec, na = String.prototype.replace, ia = ta, ra = (Qr = /a/,
  Zr = /b*/g,
  ta.call(Qr, "a"),
  ta.call(Zr, "a"),
  0 !== Qr.lastIndex || 0 !== Zr.lastIndex), aa = ea.UNSUPPORTED_Y || ea.BROKEN_CARET, oa = void 0 !== /()??/.exec("")[1];
  (ra || oa || aa) && (ia = function(e) {
      var t, n, i, r, a = this, o = aa && a.sticky, s = Gr.call(a), l = a.source, u = 0, c = e;
      return o && (-1 === (s = s.replace("y", "")).indexOf("g") && (s += "g"),
      ...
      ra && (t = a.lastIndex),
      i = ta.call(o ? n : a, c),
      o ? i ? (i.input = i.input.slice(u),
      i[0] = i[0].slice(u),
      i.index = a.lastIndex,
      a.lastIndex += i[0].length) : a.lastIndex = 0 : ra && i && (a.lastIndex = a.global ? i.index + i[0].length : t),
      oa && i && i.length > 1 && na.call(i[0], n, (function() {
  ...
  var la, ua, ca, da = function(e) {
      ...
      return e = De(e),
      w(e, va) ? e[va] : "function" == typeof e.constructor && e instanceof e.constructor ? e.constructor.prototype : e instanceof Object ? ga : null
  }
  , ma = qe("iterator"), ya = !1;
  [].keys && ("next"in (ca = [].keys()) ? (ua = pa(pa(ca))) !== Object.prototype && (la = ua) : ya = !0),
  null == la && (la = {}),
  w(la, ma) || N(la, ma, (function() {
      return this
  }
  ));
  var ba = {
  ...
  !function(e, t, n, i, r, a, o) {
      ...
      if (m && (s = pa(m.call(new e)),
      Ea !== Object.prototype && s.next && (pa(s) !== Ea && (si ? si(s, Ea) : "function" != typeof s[Aa] && N(s, Aa, Ca)),
      Bt(s, h, !0))),
      r == xa && g && g.name !== xa && (f = !0,
      p = function() {
          return g.call(this)
      }
      ),
  ...
  var Oa = qe("species")
    ...
    , Fa = function(e, t, n, i) {
      ...
      if (!o || !s || "replace" === e && (!Ta || !Da || za) || "split" === e && !Ha) {
          ...
          ie(RegExp.prototype, r, 2 == t ? function(e, t) {
  ...
  Fa("split", 2, (function(e, t, n) {
      ...
      return i = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(e, n) {
          ...
          if (void 0 === e)
              return [a];
          if (!m(i = e) || !(void 0 !== (r = i[Wa]) ? r : "RegExp" == h(i)))
              return t.call(a, e, o);
          for (var s, l, u, c = [], d = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "") + (e.sticky ? "y" : ""), f = 0, v = new RegExp(e.source,d + "g"); (s = sa.call(v, a)) && !((l = v.lastIndex) > f && (c.push(a.slice(f, s.index)),
          s.length > 1 && s.index < a.length && _a.apply(c, s.slice(1)),
          u = s[0].length,
          f = l,
          c.length >= o)); )
              v.lastIndex === s.index && v.lastIndex++;
          return f === a.length ? !u && v.test("") || c.push("") : c.push(a.slice(f)),
      ...
      , function(e, r) {
          ...
          if (0 === h)
              return [];
          if (0 === s.length)
              return null === qa(d, s) ? [s] : [];
          for (var f = 0, v = 0, g = []; v < s.length; ) {
              d.lastIndex = $a ? v : 0;
              var p, m = qa(d, $a ? s : s.slice(v));
              if (null === m || (p = Va(de(d.lastIndex + ($a ? 0 : v)), s.length)) === f)
                  v = Ba(s, v, u);
              else {
                  if (g.push(s.slice(f, v)),
                  g.length === h)
                      return g;
  ...
  Fa("search", 1, (function(e, t, n) {
      ...
      , function(e) {
          ...
          var s = qa(r, a);
          return bo(r.lastIndex, o) || (r.lastIndex = o),
          null === s ? -1 : s.index
      }
      ]
  }
  ...
  var wo = function(e, t) {
    ...
    , Po = function() {
      ...
      return void 0 !== e.dependencies && delete e.dependencies,
      e
  }
    , No = function(e) {
      ...
      t.default = function(e) {
          if (e) {
              ...
              : function() {}
                ...
                , p = function(e) {
                  var t = !1;
                  return !e.preStyleTestCompleted && (/inline-/.test(e.display) || (t = !0,
                  e.display = "inline-block"),
                  "nowrap" !== e.whiteSpace && (t = !0,
                  e.whiteSpace = "nowrap"),
                ...
                , k = function(e) {
                  e.observeMutations && (e.observer = new MutationObserver(b(e, r)),
      ...
      return no(e, [{
          ...
          value: function(e) {
              ...
              So(e, "img[data-src], video[data-src], audio[data-src], iframe[data-src]").forEach((function(e) {
                  ("IFRAME" !== e.tagName || t.shouldPreload(e)) && (e.setAttribute("src", e.getAttribute("data-src")),
              ...
              if (i) {
                  ...
                  if (!1 === i.hasAttribute("data-loaded")) {
                      ...
                      if (o)
                          r.style.backgroundImage = "url(" + encodeURI(o) + ")";
          ...
          value: function(e) {
              ...
              So(e, "video, audio").forEach((function(e) {
                  if (!xo(e, ".fragment") || xo(e, ".fragment.visible")) {
                      ...
                      if ("boolean" != typeof n && (n = e.hasAttribute("data-autoplay") || !!xo(e, ".slide-background")),
              ...
              So(e, "iframe[data-src]").forEach((function(e) {
                  xo(e, ".fragment") && !xo(e, ".fragment.visible") || e.getAttribute("src") !== e.getAttribute("data-src") && (e.removeEventListener("load", t.startEmbeddedIframe),
          ...
          value: function(e) {
              ...
              e && e.parentNode && (So(e, "video, audio").forEach((function(e) {
    ...
    , Fo = function() {
      ...
      return no(e, [{
          ...
          value: function(e, t) {
              var n = "none";
              e.slideNumber && !this.Reveal.isPrintingPDF() && ("all" === e.showSlideNumber || "speaker" === e.showSlideNumber && this.Reveal.isSpeakerNotes()) && (n = "block"),
    ...
    , Bo = function() {
      ...
      return no(e, [{
          ...
          value: function() {
              ...
              this.Reveal.getConfig().parallaxBackgroundImage ? (this.element.style.backgroundImage = 'url("' + this.Reveal.getConfig().parallaxBackgroundImage + '")',
              ...
              ), 1)) : (this.element.style.backgroundImage = "",
          ...
          value: function(e, t) {
              ...
              return i.className = "slide-background-content",
              n.appendChild(i),
              t.appendChild(n),
          ...
          value: function(e) {
              ...
              i.background && (/^(http|file|\/\/)/gi.test(i.background) || /\.(svg|png|jpg|jpeg|gif|bmp)([?#\s]|$)/gi.test(i.background) ? e.setAttribute("data-background-image", i.background) : t.style.background = i.background),
              (i.background || i.backgroundColor || i.backgroundImage || i.backgroundVideo || i.backgroundIframe) && t.setAttribute("data-background-hash", i.background + i.backgroundSize + i.backgroundImage + i.backgroundVideo + i.backgroundIframe + i.backgroundColor + i.backgroundRepeat + i.backgroundPosition + i.backgroundTransition + i.backgroundOpacity),
              ...
              if (a) {
                  var s = Uo(a);
                  s && 0 !== s.a && ("string" == typeof (r = a) && (r = Uo(r)),
          ...
          value: function() {
              ...
              if (Array.from(this.element.childNodes).forEach((function(e, n) {
                  ...
                  n < i.h ? e.classList.add(a) : n > i.h ? e.classList.add(o) : (e.classList.add("present"),
                  r = e),
                  (t || n === i.h) && So(e, ".slide-background").forEach((function(e, t) {
                      e.classList.remove("past", "present", "future"),
                      t < i.v ? e.classList.add("past") : t > i.v ? e.classList.add("future") : (e.classList.add("present"),
                      n === i.h && (r = e))
                  }
                  ))
              }
              ...
              r) {
                  ...
                  if (s) {
                      ...
                      /\.gif/i.test(l) && (s.style.backgroundImage = "",
          ...
          value: function() {
              ...
              if (this.Reveal.getConfig().parallaxBackgroundImage) {
                  ...
                  1 === a.length ? t = n = parseInt(a[0], 10) : (t = parseInt(a[0], 10),
                  n = parseInt(a[1], 10));
                  ...
                  u = "number" == typeof this.Reveal.getConfig().parallaxBackgroundVertical ? this.Reveal.getConfig().parallaxBackgroundVertical : (n - d) / (h - 1),
                  c = h > 0 ? u * e.v : 0,
  ...
  Oe({
      ...
      slice: function(e, t) {
          ...
          if (Te(a) && ("function" != typeof (n = a.constructor) || n !== Array && !Te(n.prototype) ? m(n) && null === (n = n[es]) && (n = void 0) : n = void 0,
          n === Array || void 0 === n))
              return ts.call(a, s, l);
          for (i = new (void 0 === n ? Array : n)(ns(l - s, 0)),
          r = 0; s < l; s++,
          r++)
              s in a && je(i, r, a[s]);
          return i.length = r,
  ...
  var rs = 0
    , as = function() {
      ...
      return no(e, [{
          ...
          value: function(e, t) {
              var n = this;
              if (this.reset(),
              e.hasAttribute("data-auto-animate") && t.hasAttribute("data-auto-animate")) {
                  ...
                  if ("false" !== t.dataset.autoAnimateUnmatched && !0 === this.Reveal.getConfig().autoAnimateUnmatched) {
                      ...
                      this.getUnmatchedAutoAnimateElements(t).forEach((function(e) {
                          var t = n.getAutoAnimateOptions(e, i)
                            , r = "unmatched";
                          t.duration === i.duration && t.delay === i.delay || (r = "unmatched-" + rs++,
                          a.push('[data-auto-animate="running"] [data-auto-animate-target="'.concat(r, '"] { transition: opacity ').concat(t.duration, "s ease ").concat(t.delay, "s; }"))),
                          e.dataset.autoAnimateTarget = r
                      }
                      ), this),
                      a.push('[data-auto-animate="running"] [data-auto-animate-target="unmatched"] { transition: opacity '.concat(o, "s ease ").concat(s, "s; }"))
                  }
                  this.autoAnimateStyleSheet.innerHTML = a.join(""),
                  requestAnimationFrame((function() {
                      n.autoAnimateStyleSheet && (getComputedStyle(n.autoAnimateStyleSheet).fontWeight,
          ...
          value: function() {
              ...
              this.autoAnimateStyleSheet && this.autoAnimateStyleSheet.parentNode && (this.autoAnimateStyleSheet.parentNode.removeChild(this.autoAnimateStyleSheet),
          ...
          value: function(e, t, n, i, r) {
              ...
              e.classList.contains("fragment") && (e.className.match(fo) || [""])[0] === (t.className.match(fo) || [""])[0] && "forward" === i.slideDirection && t.classList.add("visible", "disabled"));
              ...
              for (var f in s.styles) {
                  var v = s.styles[f]
                    , g = o.styles[f];
                  v === g ? delete s.styles[f] : (!0 === v.explicitValue && (s.styles[f] = v.value),
                  !0 === g.explicitValue && (o.styles[f] = g.value))
              }
              var p = ""
                , m = Object.keys(s.styles);
              m.length > 0 && (o.styles.transition = "none",
              ...
              p = '[data-auto-animate-target="' + r + '"] {' + Object.keys(o.styles).map((function(e) {
          ...
          value: function(e, t) {
              ...
              return e.dataset.autoAnimateEasing && (n.easing = e.dataset.autoAnimateEasing),
          ...
          value: function(e, t, n, i, r, a) {
              ...
              [].slice.call(t.querySelectorAll(i)).forEach((function(e, t) {
                  var n = r(e);
                  "string" == typeof n && n.length && (o[n] = o[n] || [],
                  o[n].push(e))
              }
              )),
          ...
          value: function(e) {
              ...
              return [].slice.call(e.children).reduce((function(e, n) {
                  ...
                  return n.hasAttribute("data-auto-animate-target") || i || e.push(n),
      ...
      return no(e, [{
          ...
          value: function(e) {
              ...
              return n.forEach((function(e) {
                  e.forEach((function(e) {
                      r.push(e),
                      e.setAttribute("data-fragment-index", a)
                  }
                  )),
                  a++
              }
          ...
          value: function(e, t) {
              ...
              if (r && this.Reveal.getConfig().fragments && (t = t || this.sort(r.querySelectorAll(".fragment"))).length) {
                  ...
                  Array.from(t).forEach((function(t, r) {
                      if (t.hasAttribute("data-fragment-index") && (r = parseInt(t.getAttribute("data-fragment-index"), 10)),
                      a = Math.max(a, r),
                      r <= e) {
                          var o = t.classList.contains("visible");
                          t.classList.add("visible"),
                          t.classList.remove("current-fragment"),
                          r === e && (n.Reveal.announceStatus(n.Reveal.getStatusText(t)),
      ...
      return no(e, [{
          ...
          value: function() {
              ...
              this.Reveal.getHorizontalSlides().forEach((function(t, n) {
                  ...
                  t.classList.contains("stack") && So(t, "section").forEach((function(t, i) {
                      t.setAttribute("data-index-h", n),
          ...
          value: function(e) {
              if (this.isActive()) {
                  ...
                  for (var t = e.target; t && !t.nodeName.match(/section/gi); )
                      t = t.parentNode;
                  if (t && !t.classList.contains("disabled") && (this.deactivate(),
    ...
    , ls = function() {
      ...
      return no(e, [{
          key: "configure",
          value: function(e, t) {
              "linear" === e.navigationMode ? (this.shortcuts["&#8594;  ,  &#8595;  ,  SPACE  ,  N  ,  L  ,  J"] = '<i style="color: powderblue;" class="fas fa-chevron-right"></i> Next slide',
              this.shortcuts["&#8592;  ,  &#8593;  ,  P  ,  H  ,  K"] = '<i style="color: powderblue;" class="fas fa-chevron-left"></i> Previous slide') : (this.shortcuts["N  ,  SPACE"] = '<i style="color: powderblue;" class="fas fa-chevron-right"></i> Next slide',
              this.shortcuts.P = '<i style="color: powderblue;" class="fas fa-chevron-left"></i> Previous slide',
              this.shortcuts["&#8592;  ,  H"] = '<i style="color: powderblue;" class="fas fa-chevron-left"></i> Navigate left',
              this.shortcuts["&#8594;  ,  L"] = '<i style="color: powderblue;" class="fas fa-chevron-right"></i> Navigate right',
              this.shortcuts["&#8593;  ,  K"] = '<i style="color: powderblue;" class="fas fa-chevron-up"></i> Navigate up',
              this.shortcuts["&#8595;  ,  J"] = '<i style="color: powderblue;" class="fas fa-chevron-down"></i> Navigate down'),
              this.shortcuts["Home  ,  Shift &#8592;"] = '<i style="color: powderblue;" class="fas fa-fast-backward"></i> First slide',
              this.shortcuts["End  ,  Shift &#8594;"] = '<i style="color: powderblue;" class="fas fa-fast-forward"></i> Last slide',
              this.shortcuts["B  ,  ."] = '<i style="color: powderblue;" class="fas fa-pause-circle"></i> Pause',
              this.shortcuts.F = '<i style="color: powderblue;" class="fas fa-expand"></i> Fullscreen',
              this.shortcuts["ESC, O"] = '<i style="color: powderblue;" class="fas fa-solar-panel"></i> Slide overview'
          }
      }, {
          key: "bind",
          value: function() {
          ...
          value: function(e) {
              ...
              if (!(r || a || o || c)) {
                  ...
                  if (this.Reveal.isPaused() && -1 === h.indexOf(n))
                      return !1;
                  ...
                  if ("object" === Za(t.keyboard))
                      for (d in t.keyboard)
                          if (parseInt(d, 10) === n) {
                              var m = t.keyboard[d];
                              "function" == typeof m ? m.apply(null, [e]) : "string" == typeof m && "function" == typeof this.Reveal[m] && this.Reveal[m].call(),
                              p = !0
                          }
                  if (!1 === p)
                      for (d in this.bindings)
                          if (parseInt(d, 10) === n) {
                              ...
                              "function" == typeof y ? y.apply(null, [e]) : "string" == typeof y && "function" == typeof this.Reveal[y] && this.Reveal[y].call(),
                              p = !0
                          }
                  !1 === p && (p = !0,
                  80 === n || 33 === n ? this.Reveal.prev() : 78 === n || 34 === n ? this.Reveal.next() : 72 === n || 37 === n ? l ? this.Reveal.slide(0) : !this.Reveal.overview.isActive() && g ? this.Reveal.prev() : this.Reveal.left() : 76 === n || 39 === n ? u ? this.Reveal.slide(Number.MAX_VALUE) : !this.Reveal.overview.isActive() && g ? this.Reveal.next() : this.Reveal.right() : 75 === n || 38 === n ? !this.Reveal.overview.isActive() && g ? this.Reveal.prev() : this.Reveal.up() : 74 === n || 40 === n ? !this.Reveal.overview.isActive() && g ? this.Reveal.next() : this.Reveal.down() : 36 === n ? this.Reveal.slide(0) : 35 === n ? this.Reveal.slide(Number.MAX_VALUE) : 32 === n ? (this.Reveal.overview.isActive() && this.Reveal.overview.deactivate(),
                  e.shiftKey ? this.Reveal.prev() : this.Reveal.next()) : 58 === n || 59 === n || 66 === n || 86 === n || 190 === n || 191 === n ? this.Reveal.togglePause() : 70 === n ? (f = t.embedded ? this.Reveal.getViewportElement() : document.documentElement,
                  (v = (f = f || document.documentElement).requestFullscreen || f.webkitRequestFullscreen || f.webkitRequestFullScreen || f.mozRequestFullScreen || f.msRequestFullscreen) && v.apply(f)) : 65 === n ? t.autoSlideStoppable && this.Reveal.toggleAutoSlide(i) : p = !1),
                  p ? e.preventDefault && e.preventDefault() : 27 !== n && 79 !== n || (!1 === this.Reveal.closeOverlay() && this.Reveal.overview.toggle(),
      ...
      return no(e, [{
          ...
          value: function() {
              ...
              if (!/^[0-9]*$/.test(r[0]) && a.length) {
                  var o, s;
                  /\/[-\d]+$/g.test(a) && (s = parseInt(a.split("/").pop(), 10),
                  s = isNaN(s) ? void 0 : s,
                  a = a.split("/").shift());
                  try {
                  ...
                  e.fragmentInURL && (c = parseInt(r[2], 10),
                  isNaN(c) && (c = void 0)),
          ...
          value: function(e) {
              var t = this.Reveal.getConfig()
                , n = this.Reveal.getCurrentSlide();
              if (clearTimeout(this.writeURLTimeout),
              "number" == typeof e)
          ...
          value: function(e) {
              ...
              if (this.Reveal.getConfig().fragmentInURL || (r.f = void 0),
    ...
    , cs = function() {
      ...
      return no(e, [{
          ...
          value: function() {
              ...
              this.element.innerHTML = '<button class="navigate-left" aria-label="'.concat(e ? "next slide" : "previous slide", '"><div class="controls-arrow"></div></button>\n\t\t\t<button class="navigate-right" aria-label="').concat(e ? "previous slide" : "next slide", '"><div class="controls-arrow"></div></button>\n\t\t\t<button class="navigate-up" aria-label="above slide"><div class="controls-arrow"></div></button>\n\t\t\t<button class="navigate-down" aria-label="below slide"><div class="controls-arrow"></div></button>'),
              this.Reveal.getRevealElement().appendChild(this.element),
          ...
          value: function() {
              ...
              if (this.Reveal.getConfig().controlsTutorial) {
                  ...
                  !this.Reveal.hasNavigatedVertically() && e.down ? this.controlsDownArrow.classList.add("highlight") : (this.controlsDownArrow.classList.remove("highlight"),
                  this.Reveal.getConfig().rtl ? !this.Reveal.hasNavigatedHorizontally() && e.left && 0 === i.v ? this.controlsLeftArrow.classList.add("highlight") : this.controlsLeftArrow.classList.remove("highlight") : !this.Reveal.hasNavigatedHorizontally() && e.right && 0 === i.v ? this.controlsRightArrow.classList.add("highlight") : this.controlsRightArrow.classList.remove("highlight"))
              }
          }
      }, {
    ...
    , ds = function() {
      ...
      return no(e, [{
          ...
          value: function(e) {
              ...
              this.Reveal.getConfig().rtl && (n = t - n),
              this.Reveal.slide(n)
          }
      }]),
      e
    ...
    , hs = function() {
      ...
      return no(e, [{
          ...
          value: function(e, t) {
              ...
              document.addEventListener("mousewheel", this.onDocumentMouseScroll, !1)) : (document.removeEventListener("DOMMouseScroll", this.onDocumentMouseScroll, !1),
              document.removeEventListener("mousewheel", this.onDocumentMouseScroll, !1)),
              e.hideInactiveCursor ? (document.addEventListener("mousemove", this.onDocumentCursorActive, !1),
              document.addEventListener("mousedown", this.onDocumentCursorActive, !1)) : (this.showCursor(),
          ...
          key: "showCursor",
          value: function() {
              this.cursorHidden && (this.cursorHidden = !1,
              this.Reveal.getRevealElement().style.cursor = "")
          }
      }, {
          key: "hideCursor",
          value: function() {
              !1 === this.cursorHidden && (this.cursorHidden = !0,
    ...
    , vs = function(e) {
      return function(t) {
          for (var n, i = p(t), r = St(i), a = r.length, s = 0, l = []; a > s; )
              n = r[s++],
              o && !fs.call(i, n) || l.push(e ? [n, i[n]] : i[n]);
          return l
      }
  }
    , gs = {
  ...
  var ps = function(e, t) {
      ...
      n.defer = !1,
      n.src = e,
      "function" == typeof t && (n.onload = n.onreadystatechange = function(e) {
    ...
    , ms = function() {
      ...
      return no(e, [{
          ...
          value: function(e, t) {
              ...
              new Promise((function(e) {
                  ...
                  i.length) {
                      ...
                      i.forEach((function(e) {
                          "string" == typeof e.id ? (n.registerPlugin(e),
                          a(e)) : "string" == typeof e.src ? ps(e.src, (function() {
                              return a(e)
                          }
          ...
          value: function() {
              ...
              this.asyncDependencies.length && this.asyncDependencies.forEach((function(e) {
                  ps(e.src, e.callback)
              }
              )),
              Promise.resolve()
          ...
          value: function(e) {
              ...
              var t = e.id;
              "string" != typeof t ? console.warn("Unrecognized plugin format; can't find plugin.id", e) : void 0 === this.registeredPlugins[t] ? (this.registeredPlugins[t] = e,
              "loaded" === this.state && "function" == typeof e.init && e.init(this.Reveal)) : console.warn('reveal.js: "' + t + '" plugin has already been registered')
          }
      }, {
          key: "hasPlugin",
          value: function(e) {
    ...
    , ys = function() {
      ...
      return no(e, [{
          ...
          value: function() {
              ...
              Co(".reveal section>img, .reveal section>video, .reveal section>iframe{max-width: " + r + "px; max-height:" + a + "px}"),
                  ...
                  if (!1 === t.classList.contains("stack")) {
                      ...
                      e.showNotes) {
                          ...
                          if (h) {
                              ...
                              v.innerHTML = h,
                              "separate-page" === f ? d.parentNode.insertBefore(v, d.nextSibling) : (v.style.left = "8px",
                              v.style.bottom = "8px",
    ...
    , bs = function() {
      ...
      return no(e, [{
          ...
          value: function() {
              ...
              "onpointerdown"in window ? (e.addEventListener("pointerdown", this.onPointerDown, !1),
              e.addEventListener("pointermove", this.onPointerMove, !1),
              e.addEventListener("pointerup", this.onPointerUp, !1)) : window.navigator.msPointerEnabled ? (e.addEventListener("MSPointerDown", this.onPointerDown, !1),
              e.addEventListener("MSPointerMove", this.onPointerMove, !1),
              e.addEventListener("MSPointerUp", this.onPointerUp, !1)) : (e.addEventListener("touchstart", this.onTouchStart, !1),
          ...
          value: function(e) {
              ...
              if (this.touchCaptured)
                  ...
                  if (1 === e.touches.length && 2 !== this.touchStartCount) {
                      ...
                      a > 40 && Math.abs(a) > Math.abs(o) ? (this.touchCaptured = !0,
                      "linear" === t.navigationMode ? t.rtl ? this.Reveal.next() : this.Reveal.prev() : this.Reveal.left()) : a < -40 && Math.abs(a) > Math.abs(o) ? (this.touchCaptured = !0,
                      "linear" === t.navigationMode ? t.rtl ? this.Reveal.prev() : this.Reveal.next() : this.Reveal.right()) : o > 40 && r.up ? (this.touchCaptured = !0,
                      "linear" === t.navigationMode ? this.Reveal.prev() : this.Reveal.up()) : o < -40 && r.down && (this.touchCaptured = !0,
    ...
    , Es = function() {
      ...
      return no(e, [{
          key: "configure",
          value: function(e, t) {
              e.embedded ? this.blur() : (this.focus(),
              this.unbind())
          }
      }, {
          key: "bind",
          ...
          key: "focus",
          value: function() {
              this.state !== ws && (this.Reveal.getRevealElement().classList.add("focused"),
          ...
          key: "blur",
          value: function() {
              this.state !== Ss && (this.Reveal.getRevealElement().classList.remove("focused"),
              document.removeEventListener("pointerdown", this.onDocumentPointerDown, !1)),
              this.state = Ss
          }
      }, {
  ...
  var xs = function() {
      ...
      return no(e, [{
          ...
          value: function() {
              ...
              this.context.fillRect(18, 0, 10, r)) : (this.context.beginPath(),
  ...
  function Ps(e, t) {
      ...
      e = document.querySelector(".reveal"));
      ...
      function z() {
          !0 === l.embedded ? v.viewport = xo(e, ".reveal-viewport") || e : (v.viewport = document.body,
      ...
      function H() {
          ...
          I.isPrintingPDF() && (X(),
          "complete" === document.readyState ? I.setupPDF() : window.addEventListener("load", (function() {
              I.setupPDF()
          }
          )))
      }
      ...
      function U() {
          ...
          P.render(),
          D.render(),
          v.pauseOverlay = Lo(v.wrapper, "div", "pause-overlay", l.controls ? '<button class="resume-button">Resume presentation</button>' : null),
          v.statusElement = B(),
          v.wrapper.setAttribute("role", "application")
      }
      function B() {
          var e = v.wrapper.querySelector(".aria-status");
          return e || ((e = document.createElement("div")).style.position = "absolute",
          e.style.height = "1px",
          e.style.width = "1px",
      ...
      function _() {
          setInterval((function() {
              0 === v.wrapper.scrollTop && 0 === v.wrapper.scrollLeft || (v.wrapper.scrollTop = 0,
              v.wrapper.scrollLeft = 0)
          }
          ), 1e3)
      }
      function V() {
      ...
      function K(e) {
          ...
          !1 !== s.isReady()) {
              ...
              !1 === l.pause && pe(),
              l.previewLinks ? (ee(),
              te("[data-preview-link=false]")) : (te(),
              ee("[data-preview-link]:not([data-preview-link=false])")),
              E.reset(),
              o && (o.destroy(),
              o = null),
              n > 1 && l.autoSlide && l.autoSlideStoppable && ((o = new xs(v.wrapper,(function() {
      ...
      function ne(e) {
          ...
          v.overlay.querySelector("iframe").addEventListener("load", (function(e) {
          ...
          v.overlay.querySelector(".external").addEventListener("click", (function(e) {
              ae()
          }
          ), !1)
      }
      ...
      function re() {
          if (l.help) {
              ...
              var e = '<p class="title">Keyboard Shortcuts</p><br/>'
                , t = x.getShortcuts()
                , n = x.getBindings();
              for (var i in e += "<table><th>KEY</th><th>ACTION</th>",
              t)
      ...
      function ae() {
          return !!v.overlay && (v.overlay.parentNode.removeChild(v.overlay),
          v.overlay = null,
          !0)
      }
      function oe() {
          if (v.wrapper && !I.isPrintingPDF()) {
              if (!l.disableLayout) {
                  ...
                  J({
                      layout: ""
                  })) : h > 1 && jo && window.devicePixelRatio < 2 ? (v.slides.style.zoom = h,
                  v.slides.style.left = "",
                  v.slides.style.top = "",
                  v.slides.style.bottom = "",
                  v.slides.style.right = "",
                  ...
                  for (var n = Array.from(v.wrapper.querySelectorAll(lo)), i = 0, r = n.length; i < r; i++) {
                      var a = n[i];
                      "none" !== a.style.display && (l.center || a.classList.contains("center") ? 
                        a.classList.contains("stack") ? 
                          a.style.paddingTop = 0 : 
                          // Move the position of the slide content down to make room for the header. (Added by iwasakishuto <https://github.com/iwasakishuto>)
                          a.style.paddingTop = Math.max((e.height - (a.scrollHeight-65)) / 2, 65) + "px" 
                        : a.style.paddingTop = "")
                  }
                  t !== h && Q({
                      type: "resize",
      ...
      function le(e, t) {
          ...
          return n.presentationWidth -= n.presentationWidth * l.margin,
      ...
      function Se(e, t, o, s) {
          ...
          // Add "MJXc-display-wrapper" class to <code> wrapping <span.MJXc-display> (Added by iwasakishuto <https://github.com/iwasakishuto>)
          var codes = document.querySelectorAll("code");
          for (let idx=0; idx<codes.length; idx++){
              if (codes[idx].querySelector("span.MJXc-display") != null){
                  codes[idx].classList.add("MJXc-display-wrapper")
              }
          }
          if (0 !== u.length) {
              ...
              var h = n || 0
                , f = i || 0;
              n = xe(uo, void 0 === e ? n : e),
              i = xe(co, void 0 === t ? i : t);
              var p = n !== h || i !== f;
              p || (r = null);
              var m = u[n]
              ...
              a = y[i] || m;
              var b = !1;
              p && r && a && !R.isActive() && (r.hasAttribute("data-auto-animate") && a.hasAttribute("data-auto-animate") && (b = !0,
              v.slides.classList.add("disable-slide-transitions")),
              g = "running"),
              Le(),
              oe(),
              R.isActive() && R.update(),
              void 0 !== o && A.goto(o),
              r && r !== a && (r.classList.remove("present"),
      ...
      function Ee() {
          ...
          !1 === l.autoPlayMedia ? w.stopEmbeddedContent(a, {
              unloadIframes: !1
          }) : w.startEmbeddedContent(a),
          R.isActive() && R.layout()
      }
      ...
      function xe(e, t) {
          ...
          if (i) {
              ...
              for (var a = 0; a < i; a++) {
                  ...
                  r ? o.classList.add("present") : a < t ? (o.classList.add(s ? "future" : "past"),
                  l.fragments && So(o, ".fragment").forEach((function(e) {
                      e.classList.add("visible"),
                      e.classList.remove("current-fragment")
                  }
                  ))) : a > t && (o.classList.add(s ? "past" : "future"),
                  l.fragments && So(o, ".fragment.visible").forEach((function(e) {
                      e.classList.remove("visible", "current-fragment")
                  }
                  )))
              }
      ...
      function Ce() {
          ...
          if (l.loop && (a.length > 1 && (s.left = !0,
          s.right = !0),
          o.length > 1 && (s.up = !0,
          s.down = !0)),
          a.length > 1 && "linear" === l.navigationMode && (s.right = s.right || s.down,
          s.left = s.left || s.up),
          !0 === r) {
      ...
      function _e() {
          ...
          a && !1 !== l.autoSlide) {
              ...
              t ? p = parseInt(t, 10) : i ? p = parseInt(i, 10) : n ? p = parseInt(n, 10) : (p = l.autoSlide,
              0 === a.querySelectorAll(".fragment").length && So(a, "video, audio").forEach((function(e) {
      ...
      function Xe() {
          ...
          l.rtl ? (R.isActive() || !1 === A.next()) && Ce().left && Se(n + 1, "grid" === l.navigationMode ? i : void 0) : (R.isActive() || !1 === A.prev()) && Ce().left && Se(n - 1, "grid" === l.navigationMode ? i : void 0)
      }
      function Ye() {
          c.hasNavigatedHorizontally = !0,
          l.rtl ? (R.isActive() || !1 === A.prev()) && Ce().right && Se(n - 1, "grid" === l.navigationMode ? i : void 0) : (R.isActive() || !1 === A.next()) && Ce().right && Se(n + 1, "grid" === l.navigationMode ? i : void 0)
      }
      function Ge() {
      ...
      function Ze() {
          if (c.hasNavigatedHorizontally = !0,
          c.hasNavigatedVertically = !0,
          !1 === A.next()) {
              var e = Ce();
      ...
      function tt(e) {
          "running" === g && /section/gi.test(e.target.nodeName) && (g = "idle",
          Q({
      ...
      function it(e) {
          !1 === document.hidden && document.activeElement !== document.body && ("function" == typeof document.activeElement.blur && document.activeElement.blur(),
          document.body.focus())
      }
      function rt(e) {
  ...
  return Ns.initialize = function(e) {
      return Object.assign(Ns, new Ps(document.querySelector(".reveal"),e)),
      Ms.map((function(e) {
          return e(Ns)
      }
      )),
