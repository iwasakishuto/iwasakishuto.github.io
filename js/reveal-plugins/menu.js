!function(e, t) {
  ...
  var M, R, j, N, _ = I.inspectSource, F = r.WeakMap, W = "function" == typeof F && /native code/.test(_(F)), H = t((function(e) {
  ...
  var J = {
    ...
    , Z = t((function(e) {
      ...
      (e.exports = function(e, t, a, o) {
          var s = !!o && !!o.unsafe
            , l = !!o && !!o.enumerable
            , c = !!o && !!o.noTargetGet;
          "function" == typeof a && ("string" != typeof t || b(a, "name") || A(a, "name", t),
          n(a).source = i.join("string" == typeof t ? t : "")),
          e !== r ? (s ? !c && e[t] && (l = !0) : delete e[t],
          l ? e[t] = a : A(e, t, a)) : l ? e[t] = a : k(t, a)
      }
    ...
    , Ne = function(e) {
      return b(Me, e) || (Ie && b(Re, e) ? Me[e] = Re[e] : Me[e] = je("Symbol." + e)),
      Me[e]
  }
    , _e = Ne("species")
    , Fe = function(e, t) {
      var n;
      return ke(e) && ("function" != typeof (n = e.constructor) || n !== Array && !ke(n.prototype) ? v(n) && null === (n = n[_e]) && (n = void 0) : n = void 0),
    ...
    , He = function(e) {
      ...
      return function(s, l, c, u) {
          ...
          }(l, c, 3), g = oe(m.length), y = 0, b = u || Fe, S = t ? b(s, g) : n ? b(s, 0) : void 0; g > y; y++)
              if ((o || y in m) && (d = v(f = m[y], y, h),
              e))
                  if (t)
                      S[y] = d;
                  else if (d)
  ...
  var bt = Math.min
    ...
    , Lt = Et || !xt || !wt ? function(e) {
      if (Et)
          return St.apply(this, arguments) || 0;
      var t = m(this)
        , n = oe(t.length)
        , r = n - 1;
      for (arguments.length > 1 && (r = bt(r, ie(arguments[1]))),
      r < 0 && (r = n + r); r >= 0; r--)
          if (r in t && t[r] === e)
              return r || 0;
      return -1
  ...
  Ce({
      ...
      slice: function(e, t) {
          ...
          if (ke(a) && ("function" != typeof (n = a.constructor) || n !== Array && !ke(n.prototype) ? v(n) && null === (n = n[Pt]) && (n = void 0) : n = void 0,
          n === Array || void 0 === n))
              return Mt.call(a, s, l);
          for (r = new (void 0 === n ? Array : n)(Rt(l - s, 0)),
          i = 0; s < l; s++,
          i++)
              s in a && At(r, i, a[s]);
          return r.length = i,
  ...
  }, sn = RegExp.prototype.exec, ln = String.prototype.replace, cn = sn, un = (rn = /a/,
  an = /b*/g,
  sn.call(rn, "a"),
  sn.call(an, "a"),
  0 !== rn.lastIndex || 0 !== an.lastIndex), fn = on.UNSUPPORTED_Y || on.BROKEN_CARET, dn = void 0 !== /()??/.exec("")[1];
  (un || dn || fn) && (cn = function(e) {
      ...
      r[0] = r[0].slice(c),
      r.index = a.lastIndex,
      a.lastIndex += r[0].length) : a.lastIndex = 0 : un && r && (a.lastIndex = a.global ? r.index + r[0].length : t),
      dn && r && r.length > 1 && ln.call(r[0], n, (function() {
  ...
  Ce({
      target: "String",
      proto: !0,
      forced: !!(wn || (hn = Sn(String.prototype, "endsWith"),
      !hn || hn.writable)) && !wn
  }, {
      endsWith: function(e) {
          var t = String(h(this));
  ...
  var Ln = Ne("species")
    ...
    , In = function(e, t, n, r) {
      ...
      if (!o || !s || "replace" === e && (!Tn || !Cn || An) || "split" === e && !kn) {
          var l = /./[a]
            , c = n(a, ""[e], (function(e, t, n, r, i) {
              return t.exec === pn ? o && !i ? {
                  done: !0,
                  value: l.call(t, n, r)
              } : {
                  done: !0,
          ...
          Z(RegExp.prototype, a, 2 == t ? function(e, t) {
  ...
  In("search", 1, (function(e, t, n) {
      ...
      , function(e) {
          ...
          var s = jn(i, a);
          return Un(i.lastIndex, o) || (i.lastIndex = o),
          null === s ? -1 : s.index
      }
      ]
  }
  ...
  In("split", 2, (function(e, t, n) {
      ...
      return r = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(e, n) {
          ...
          if (!vn(e))
              return t.call(r, e, i);
          for (var a, o, s, l = [], c = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "") + (e.sticky ? "y" : ""), u = 0, f = new RegExp(e.source,c + "g"); (a = pn.call(f, r)) && !((o = f.lastIndex) > u && (l.push(r.slice(u, a.index)),
          a.length > 1 && a.index < r.length && Dn.apply(l, a.slice(1)),
          s = a[0].length,
          u = o,
          l.length >= i)); )
              f.lastIndex === a.index && f.lastIndex++;
          return u === r.length ? !s && f.test("") || l.push("") : l.push(r.slice(u)),
      ...
      , function(e, i) {
          ...
          if (0 === d)
              return [];
          if (0 === s.length)
              return null === jn(f, s) ? [s] : [];
          for (var p = 0, h = 0, m = []; h < s.length; ) {
              f.lastIndex = Bn ? h : 0;
              var v, g = jn(f, Bn ? s : s.slice(h));
              if (null === g || (v = qn(oe(f.lastIndex + (Bn ? 0 : h)), s.length)) === p)
                  h = Rn(s, h, c);
              else {
                  if (m.push(s.slice(p, h)),
                  m.length === d)
                      return m;
  ...
  function() {
      var e, t, n, r, i = (e = /(msie) ([\w.]+)/.exec(window.navigator.userAgent.toLowerCase())) && "msie" === e[1] ? parseFloat(e[2]) : null, a = !1;
      function o(e) {
          ...
          !0 === r.themes ? r.themes = [{
              ...
              name: "White",
              theme: r.themesPath + "white.css"
          }, {
              name: "League",
              theme: r.themesPath + "league.css"
          }, {
              name: "Sky",
              theme: r.themesPath + "sky.css"
          }, {
              name: "Beige",
              theme: r.themesPath + "beige.css"
          }, {
              name: "Simple",
              theme: r.themesPath + "simple.css"
          }, {
              name: "Serif",
              theme: r.themesPath + "serif.css"
          }, {
              name: "Blood",
              theme: r.themesPath + "blood.css"
          }, {
              name: "Night",
              theme: r.themesPath + "night.css"
          }, {
              name: "Moon",
              theme: r.themesPath + "moon.css"
          }, {
              name: "Solarized",
              theme: r.themesPath + "solarized.css"
          }] : Array.isArray(r.themes) || (r.themes = !1),
          void 0 === r.transitions && (r.transitions = !1),
          !0 === r.transitions ? r.transitions = ["None", "Fade", "Slide", "Convex", "Concave", "Zoom"] : !1 === r.transitions || Array.isArray(r.transitions) && r.transitions.every((function(e) {
          ...
          if (b())
              ...
              case 38:
                  if (s = O(".active-menu-panel .slide-menu-items li.selected") || O(".active-menu-panel .slide-menu-items li.active"))
                      ...
                      (o = O(".active-menu-panel .slide-menu-items li.slide-menu-item")) && h(o);
                  break;
              case 74:
              case 40:
                  if (s = O(".active-menu-panel .slide-menu-items li.selected") || O(".active-menu-panel .slide-menu-items li.active"))
              ...
              case 85:
                  ...
                  r && (r.classList.contains("selected") && t.length > 0 && (p(r),
                  r = (n = A(".active-menu-panel .slide-menu-items li").filter((function(e) {
                      return 0 == u(e)
                  }
                  )))[0] == r ? t[t.length - 1] : n[0]),
                  A(".active-menu-panel .slide-menu-items li").forEach((function(e) {
                      e.classList.remove("selected")
                  }
                  )),
              ...
              case 68:
                  ...
                  a && (a.classList.contains("selected") && i.length > 0 && (d(a),
                  a = (n = A(".active-menu-panel .slide-menu-items li").filter((function(e) {
                      return 0 == u(e)
                  }
                  )))[n.length - 1] == a ? i[0] : n[n.length - 1]),
                  A(".active-menu-panel .slide-menu-items li").forEach((function(e) {
                      e.classList.remove("selected")
                  }
                  )),
              ...
              case 36:
                  ...
                  (o = O(".active-menu-panel .slide-menu-items li:first-of-type")) && (o.classList.add("selected"),
                  f(o));
                  break;
              case 35:
                  var o;
                  ...
                  (o = O(".active-menu-panel .slide-menu-items:last-of-type li:last-of-type")) && (o.classList.add("selected"),
                  f(o));
                  break;
              case 32:
              case 13:
      ...
      function g(e, t) {
          e && e.preventDefault(),
          r.sticky && !t || (O("body").classList.remove("slide-menu-active"),
      ...
      function E(e, n) {
          ...
          var c = O("a", e);
          c && (n || !r.sticky || r.autoOpen && c.href.startsWith("#") || c.href.startsWith(window.location.origin + window.location.pathname + "#")) && c.click(),
          g()
      }
      function x(e) {
      ...
      function C() {
          if (!a) {
              var e = function(e, t, n, r, i, a) {
                  ...
                  t && (o["data-panel"] = t);
                  var s = k("li", o);
                  return n.startsWith("fa-") ? s.appendChild(k("i", {
                      class: r + " " + n
                  })) : s.innerHTML = n + "</i>",
                  s.appendChild(k("br"), O("i", s)),
                  s.appendChild(k("span", {
                ...
                , i = function(e, i, a, o, s) {
                  ...
                  if (r.markers && (u.appendChild(k("i", {
                  ...
                  r.numbers) {
                      var f = []
                        , d = "h.v";
                      switch ("string" == typeof r.numbers ? d = r.numbers : "string" == typeof n.slideNumber && (d = n.slideNumber),
                      d) {
                      case "c":
                          f.push(a + 1);
                          break;
              ...
              l.appendChild(c);
              var u = k("nav", {
                  class: "slide-menu slide-menu--" + r.side
              });
              "string" == typeof r.width && (-1 != ["normal", "wide", "third", "half", "full"].indexOf(r.width) ? u.classList.add("slide-menu--" + r.width) : (u.classList.add("slide-menu--custom"),
              ...
              r.custom && r.custom.forEach((function(t, n, r) {
              ...
              if (p.appendChild(k("i", {
                  class: "fas fa-times"
              })),
              p.appendChild(k("br")),
              p.appendChild(k("span", {
                  class: "slide-menu-toolbar-label"
              }, "Close")),
              p.onclick = function() {
                  g(null, !0)
              ...
              r.custom) {
                  ...
                  r.custom.forEach((function(e, t, n) {
                      ...
                      e.content ? (r.innerHTML = e.content,
                      C(r)) : e.src && function(e, t) {
              ...
              if (r.openSlideNumber)
                  O("div.slide-number").onclick = v;
          ...
          if (r.keyboard) {
              if (document.addEventListener("keydown", m, !1),
              ...
              t.addKeyBinding({
                  keyCode: 77,
                  key: "M",
                  description: "<i class='fas fa-bars' style='color: gold;'></i> Toggle menu"
              }, y)
          }
          r.openOnInit && v(),
          a = !0
      ...
      function M() {
          ...
          n.postMessageEvents && window.parent !== window.self && window.parent.postMessage(JSON.stringify({
              namespace: "reveal",
              eventName: e,
              state: t.getState()
          }), "*"))
      ...
      return {
          ...
          init: function(e) {
              ...
              if (curt_path){
                ...
                curt_path = Reveal.getConfig().pluginBaseDirectory + "menu.css";
              }
