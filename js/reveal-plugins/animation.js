/*****************************************************************
** Author: rogeralmeida <https://github.com/rogeralmeida>
**
** License: MIT license (see LICENSE.md)
**
** Editor: iwasakishuto <https://github.com/iwasakishuto>
******************************************************************/

window.RevealJsAnimation = window.RevealJsAnimation || {
  id: 'RevealJsAnimation',
  init: function(deck) {
    initRevealJsAnimation(deck);
  }
};
...
const initRevealJsAnimation = function(Reveal){
